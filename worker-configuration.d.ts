/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eaafa5b276b838c695d2d6f9a481fe0a)
...
declare namespace Cloudflare {
	...
	interface Env {
		QUEUE: Queue;
		BROADCASTER_ID: "55899594";
		TWITCH_CLIENT_ID: string;
		TWITCH_CLIENT_SECRET: string;
		WEBHOOK_SECRET: string;
		GSHEET_SPREADSHEET_ID: string;
		GSHEET_SHEET_NAME: string;
		GSHEET_CREDENTIALS: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BROADCASTER_ID" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "WEBHOOK_SECRET" | "GSHEET_SPREADSHEET_ID" | "GSHEET_SHEET_NAME" | "GSHEET_CREDENTIALS">> {}
}
